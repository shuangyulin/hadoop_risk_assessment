	...
	<div class="main-content" :style='{"color":"#666","padding":"30px","fontSize":"16px"}'>
		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"margin":"0 0 20px","flexWrap":"wrap","justifyContent":"space-between","display":"flex"}' :inline="true" :model="searchForm">
				...
				<el-row class="actions" :style='{"margin":"10px 0","fontSize":"inherit","flexWrap":"wrap","display":"flex"}'>
					<el-button class="add" v-if="isAuth('creditdata','新增')" type="success" @click="addOrUpdateHandler()">
						<span class="icon iconfont icon-tianjia14" :style='{"margin":"0 0px","fontSize":"inherit","color":"inherit","height":"34px"}'></span>
						添加
					</el-button>
					<el-button class="del" v-if="isAuth('creditdata','删除')" :disabled="dataListSelections.length?false:true" type="danger" @click="deleteHandler()">
						<span class="icon iconfont icon-shanchu15" :style='{"margin":"0 0px","fontSize":"inherit","color":"inherit","height":"34px"}'></span>
						删除
					</el-button>

					<el-button class="btn18" v-if="isAuth('creditdata','导入')" type="success" @click="importHandler()">
						<span class="icon iconfont icon-daoru11" :style='{"margin":"0 0px","fontSize":"inherit","color":"inherit","height":"34px"}'></span>
						导入
					</el-button>
					<el-button class="btn18" v-if="isAuth('creditdata','上传模板')" type="success" @click="importClcik">
						<span class="icon iconfont icon-shangchuan8" :style='{"margin":"0 0px","fontSize":"inherit","color":"inherit","height":"34px"}'></span>
						上传模板
					</el-button>
					<el-button class="btn18" v-if="isAuth('creditdata','下载模板')" type="success" @click="download('upload/creditdata_template.xlsx')">
						<span class="icon iconfont icon-xiazai7" :style='{"margin":"0 0px","fontSize":"inherit","color":"inherit","height":"34px"}'></span>
						下载模板
					</el-button>

					<download-excel v-if="isAuth('creditdata','导出')" class="export-excel-wrapper" :data = "dataList" :fields = "json_fields" name = "信贷数据.xls">
						<!-- 导出excel -->
					...
					<el-button class="btn18" v-if="isAuth('creditdata','性别统计')" type="success" @click="chartDialog1()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 0px","fontSize":"inherit","color":"inherit","height":"34px"}'></span>
						性别统计
					</el-button>
					<el-button class="btn18" v-if="isAuth('creditdata','年龄区间')" type="success" @click="chartDialog2()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 0px","fontSize":"inherit","color":"inherit","height":"34px"}'></span>
						年龄区间
					</el-button>
					<el-button class="btn18" v-if="isAuth('creditdata','年收入')" type="success" @click="chartDialog3()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 0px","fontSize":"inherit","color":"inherit","height":"34px"}'></span>
						年收入
					</el-button>
					<el-button class="btn18" v-if="isAuth('creditdata','资产总额')" type="success" @click="chartDialog4()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 0px","fontSize":"inherit","color":"inherit","height":"34px"}'></span>
						资产总额
					</el-button>
					<el-button class="btn18" v-if="isAuth('creditdata','负债总额')" type="success" @click="chartDialog5()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 0px","fontSize":"inherit","color":"inherit","height":"34px"}'></span>
						负债总额
					</el-button>
					<el-button class="btn18" v-if="isAuth('creditdata','信用卡额度')" type="success" @click="chartDialog6()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 0px","fontSize":"inherit","color":"inherit","height":"34px"}'></span>
						信用卡额度
					</el-button>
					<el-button class="btn18" v-if="isAuth('creditdata','贷款金额')" type="success" @click="chartDialog7()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 0px","fontSize":"inherit","color":"inherit","height":"34px"}'></span>
						贷款金额
					</el-button>
					<el-button class="btn18" v-if="isAuth('creditdata','信用评分')" type="success" @click="chartDialog8()">
						<span class="icon iconfont icon-xihuan" :style='{"margin":"0 0px","fontSize":"inherit","color":"inherit","height":"34px"}'></span>
						信用评分
					</el-button>
				</el-row>
			...
			<div :style='{"width":"100%","padding":"0px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true'  
						prop="creditcardusagerate"
						label="信用卡使用率">
						<template slot-scope="scope">
							{{scope.row.creditcardusagerate}}
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='true'  
						prop="creditscore"
					...
					<el-table-column :resizable='true' :sortable='true'  
						prop="credithistorylength"
						label="信用历史长度">
						<template slot-scope="scope">
							{{scope.row.credithistorylength}}
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='true'  
						prop="numberofoverduetimes"
						label="逾期次数">
						<template slot-scope="scope">
							{{scope.row.numberofoverduetimes}}
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='true'  
						prop="seriousoverduetimes"
						label="严重逾期次数">
						<template slot-scope="scope">
							{{scope.row.seriousoverduetimes}}
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='true'  
						prop="overdueamount"
					...
					<el-table-column :resizable='true' :sortable='true'  
						...
						label="信用查询次数">
						<template slot-scope="scope">
							{{scope.row.creditinquiryfrequency}}
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='true'  
						prop="loanamount"
					...
					<el-table-column :resizable='true' :sortable='true'  
						...
						label="贷款用途">
						<template slot-scope="scope">
							{{scope.row.loanpurpose}}
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='true'  
						prop="remainingloanterm"
						label="剩余贷款期限">
						<template slot-scope="scope">
							{{scope.row.remainingloanterm}}
						</template>
					</el-table-column>
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							<el-button class="view" v-if=" isAuth('creditdata','查看')" type="success" @click="addOrUpdateHandler(scope.row.id,'info')">
								<span class="icon iconfont icon-tianjia14" :style='{"margin":"0 0px","fontSize":"14px","color":"inherit","height":"40px"}'></span>
								查看
							</el-button>
							<el-button class="edit" v-if=" isAuth('creditdata','修改') " type="success" @click="addOrUpdateHandler(scope.row.id)">
							...
							<el-button class="del" v-if="isAuth('creditdata','删除') " type="primary" @click="deleteHandler(scope.row.id )">
		...
		<el-dialog title="上传模板" :visible.sync="importVis" width="50%">
			<el-form ref="form" :model="importForm" label-width="80px">
				<el-form-item class="upload" label="文件" prop="excelFile">
					<el-upload class="upload-demo" drag :action="$base.url + 'file/upload?type=creditdata_template'"
		...
		<el-dialog
			...
			width="800">
			<div id="ageChart2" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="annualincomeChart3" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="totalassetsChart4" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="totalliabilitiesChart5" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="creditlimitChart6" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="loanamountChart7" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
		...
		<el-dialog
			...
			width="800">
			<div id="creditscoreChart8" style="width:100%;height:600px;"></div>
			<span slot="footer" class="dialog-footer">
...
//导出excel
				json_fields: {
					...
					"年龄": "age",    //常规字段
					"地区": "area",    //常规字段
					"教育程度": "educationlevel",    //常规字段
					"婚姻状况": "maritalstatus",    //常规字段
					"家庭人数": "householdsize",    //常规字段
					"年收入": "annualincome",    //常规字段
					"月收入": "monthlyincome",    //常规字段
					"职业": "career",    //常规字段
					"工作年限": "yearsofservice",    //常规字段
					"资产总额": "totalassets",    //常规字段
					"负债总额": "totalliabilities",    //常规字段
					"负债率": "debtratio",    //常规字段
					"信用卡额度": "creditlimit",    //常规字段
					"信用卡使用率": "creditcardusagerate",    //常规字段
					"信用评分": "creditscore",    //常规字段
					"信用历史长度": "credithistorylength",    //常规字段
					"逾期次数": "numberofoverduetimes",    //常规字段
					"严重逾期次数": "seriousoverduetimes",    //常规字段
					"逾期金额": "overdueamount",    //常规字段
					"逾期天数": "overduedays",    //常规字段
					"信用查询次数": "creditinquiryfrequency",    //常规字段
					"贷款金额": "loanamount",    //常规字段
					"贷款期限": "loanterm",    //常规字段
					"贷款利率": "lendingrate",    //常规字段
					"还款方式": "repaymentmethod",    //常规字段
					"贷款用途": "loanpurpose",    //常规字段
					"剩余贷款期限": "remainingloanterm",    //常规字段
				},
				json_meta: [
					[
						{
		...
		methods: {
			...
			chartDialog2() {
				...
				this.$nextTick(()=>{
					...
					var ageChart2 = echarts.init(document.getElementById("ageChart2"),'macarons');
					this.$http({
			...
			chartDialog3() {
				...
				this.$nextTick(()=>{
					...
					var annualincomeChart3 = echarts.init(document.getElementById("annualincomeChart3"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							annualincomeChart3.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								annualincomeChart3.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog4() {
				...
				this.$nextTick(()=>{
					...
					var totalassetsChart4 = echarts.init(document.getElementById("totalassetsChart4"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							totalassetsChart4.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								totalassetsChart4.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog5() {
				...
				this.$nextTick(()=>{
					...
					var totalliabilitiesChart5 = echarts.init(document.getElementById("totalliabilitiesChart5"),'macarons');
					this.$http({
						...
						if (data && data.code === 0) {
							...
							// 使用刚指定的配置项和数据显示图表。
							totalliabilitiesChart5.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								totalliabilitiesChart5.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog6() {
				...
				this.$nextTick(()=>{
					...
					var creditlimitChart6 = echarts.init(document.getElementById("creditlimitChart6"),'macarons');
					this.$http({
						url: `creditdata/value/number/creditlimit`,
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							creditlimitChart6.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								creditlimitChart6.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog7() {
				...
				this.$nextTick(()=>{
					...
					var loanamountChart7 = echarts.init(document.getElementById("loanamountChart7"),'macarons');
					this.$http({
						url: `creditdata/value/number/loanamount`,
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							loanamountChart7.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								loanamountChart7.resize();
							};
						}else{
							this.$message({
								message: data.msg,
			...
			chartDialog8() {
				...
				this.$nextTick(()=>{
					...
					var creditscoreChart8 = echarts.init(document.getElementById("creditscoreChart8"),'macarons');
					this.$http({
						url: `creditdata/value/number/creditscore`,
						method: "get",
					}).then(({ data }) => {
						if (data && data.code === 0) {
							let res = data.data;
							...
							// 使用刚指定的配置项和数据显示图表。
							creditscoreChart8.setOption(option);
							//根据窗口的大小变动图表
							window.onresize = function() {
								creditscoreChart8.resize();
							};
						}else{
							this.$message({
								message: data.msg,
